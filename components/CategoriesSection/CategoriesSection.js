...
function CategoryTshirtCard(props){
    return(
      <div className='relative w-[300px] h-[400px] lg:w-[280px] lg:h-[374px] object-cover overflow-hidden after:absolute after:w-full after:h-1/5 after:bottom-[-18px] after:bg-gradient-to-t after:from-[hsl(0,0%,15%)] after:from-0% after:to-100% group'>
          <Image
              src={props.imgSrc}
              width="400"
              height="600"
              alt='Men wearing T-shirt'
              className='w-full h-full object-cover group-hover:opacity-75 group-hover:scale-105 transition-all duration-200'
          />
    ...
    return (
        <section className="bg-white w-full lg:mb-32">
            <div className='my-0 py-10 lg:py-0 text-black'>
                ...
                <div 
                    className='grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 md:px-4 xl:px-0 justify-center place-items-center gap-y-8 mb-12'>
                    {CategoryTshirts}
                </div>
            </div>
        </section>
